...
export default function NFTReservation({ property, isOpen, onClose }: NFTReservationProps) {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">Bloqueo legal con tecnología blockchain</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6">
          ...
          <div className="glass p-4 rounded-xl mb-6">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                ...
                <div className="font-bold text-white">€{reservationAmount.toLocaleString()}</div>
              </div>
            </div>
          </div>
          ...
          {step === 'connect' && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-white mb-2">Conectar Wallet</h3>
              ...
              <div className="glass p-4 rounded-xl bg-gradient-to-r from-neon-teal/10 to-neon-emerald/10 border border-neon-teal/20">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="text-white font-medium mb-1">¿Qué es una Reserva NFT?</h4>
                    <p className="text-white/70 text-sm">
                      El NFT funciona como un comprobante legal inmutable de tu señal. 
                      Te garantiza prioridad de compra durante 48 horas y es válido ante notaría.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {step === 'confirm' && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-white mb-2">Wallet Conectado</h3>
                <p className="text-white/70 text-sm">
                  {walletAddress}
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="glass p-4 rounded-xl">
                  <h4 className="font-bold text-white mb-3">Detalles de la Reserva</h4>
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-neon-teal font-bold">€{reservationAmount.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="border-t border-white/10 pt-3 flex justify-between">
                      ...
                      <span className="text-white font-bold">€{(reservationAmount + 15).toLocaleString()}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass p-4 rounded-xl bg-yellow-500/10 border border-yellow-500/20">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="text-yellow-400 font-medium mb-1">Condiciones Legales</h4>
                      <ul className="text-white/70 text-sm space-y-1">
                        <li>• La señal se descontará del precio final de compra</li>
          ...
          {step === 'processing' && (
            <div className="space-y-6 text-center py-8">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Procesando NFT</h3>
                <p className="text-white/70 text-sm">
                  Creando tu reserva en blockchain...
                </p>
              </div>
              <div className="space-y-2">
                <div className="text-sm text-white/60">• Mintiendo NFT de reserva</div>
                <div className="text-sm text-white/60">• Generando documento legal</div>
                <div className="text-sm text-white/60">• Confirmando en blockchain</div>
              </div>
            </div>
          )}
          ...
          {step === 'success' && reservation && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <h3 className="text-lg font-bold text-white mb-2">¡Reserva Confirmada!</h3>
                <p className="text-white/70 text-sm">
              ...
              <div className="glass p-4 rounded-xl bg-gradient-to-r from-neon-teal/20 to-neon-emerald/20">
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-neon-teal">{timeRemaining}</div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="glass p-4 rounded-xl">
                  <h4 className="font-bold text-white mb-3">Detalles del NFT</h4>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-white/70">NFT ID:</span>
                      <div className="flex items-center space-x-2">
                        <span className="text-white font-mono text-sm">{reservation.nftId}</span>
                        <button
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          onClick={() => copyToClipboard(reservation.blockchainTxHash)}
                          className="text-neon-teal hover:text-neon-emerald transition-colors"
                        >
                          <Copy className="w-4 h-4" />
                        </button>
