...
const quantumExperiences: QuantumExperience[] = [
  {
    ...
    type: "travel",
    description:
      "Vuelo en jet privado sobre el Mediterráneo con champagne Dom Pérignon",
    immersive_preview:
      "Cielos dorados, vistas del mar infinito, champagne burbujeando",
    rarity: "legendary",
    token_color: "#FFD700",
  ...
  },
  {
    ...
    type: "culinary",
    description:
      "Experiencia gastronómica de 12 platos en estación espacial orbital",
    immersive_preview:
      "Gravedad cero, vista de la Tierra, cristalería flotante",
    rarity: "quantum",
    token_color: "#A855F7",
  ...
  },
  {
    ...
    type: "luxury",
    description:
      "Tratamiento de relajación en cueva natural llena de cristales",
    immersive_preview:
      "Cristales gigantes, aguas termales, aromaterapia cuántica",
    rarity: "rare",
    token_color: "#0EE7E7",
  ...
  },
  {
    ...
    immersive_preview:
      "Lava burbujeante, vapores geotérmicos, aterrizaje épico",
    rarity: "epic",
    token_color: "#FF4500",
  ...
  },
  {
    ...
    type: "luxury",
    description:
      "Noche completa observando auroras desde iglú térmico transparente",
  ...
  },
  {
    ...
    type: "culinary",
    description:
      "Cata de vinos centenarios en castillo restaurado del siglo XII",
  ...
  },
  {
    ...
    type: "adventure",
    description:
      "Inmersión en submarino personal para explorar arrecifes vírgenes",
    immersive_preview:
      "Corales fluorescentes, peces tropicales, aguas cristalinas",
    rarity: "epic",
    token_color: "#00CED1",
...
export default function QuantumExperienceTokens() {
  ...
  const [selectedToken, setSelectedToken] = useState<QuantumExperience | null>(
    null,
  );
  const [vaultOpen, setVaultOpen] = useState(false);
  const [currentVault, setCurrentVault] = useState<TokenVault>(
    vaultConfigurations[0],
  );
  const [viewMode, setViewMode] = useState<"vault" | "collection" | "market">(
    "vault",
  );
  ...
  const tokenMeshes = useRef<
    Array<{ mesh: THREE.Mesh; experience: QuantumExperience }>
  >([]);
  ...
  useEffect(() => {
    ...
    const vaultMaterial = new THREE.ShaderMaterial({
      uniforms: {
        time: { value: 0 },
        vault_security: {
          value: getSecurityLevel(currentVault.security_level),
        },
        vault_open: { value: 0.0 },
        holographic_active: {
          value: currentVault.holographic_display ? 1.0 : 0.0,
        },
      },
      vertexShader: `
    ...
    quantumExperiences.forEach((experience, index) => {
      ...
      const tokenMaterial = new THREE.ShaderMaterial({
        uniforms: {
          ...
          quantum_entangled: {
            value: experience.quantum_entangled ? 1.0 : 0.0,
          },
    ...
    const onMouseClick = (event: MouseEvent) => {
      ...
      const intersects = raycaster.intersectObjects(
        tokenMeshes.current.map((t) => t.mesh),
      );

      if (intersects.length > 0) {
        const clickedToken = intersects[0].object.userData
          .experience as QuantumExperience;
  ...
  const getRarityIcon = (rarity: string) => {
    switch (rarity) {
      ...
      case "epic":
        return <Gem className="w-5 h-5 text-violet-400" />;
      case "rare":
        return <Sparkles className="w-5 h-5 text-blue-400" />;
      case "common":
        return <Gift className="w-5 h-5 text-gray-400" />;
      default:
  ...
  const getRarityColor = (rarity: string) => {
    switch (rarity) {
      ...
      case "epic":
        return "text-violet-400 bg-violet-900/20 border-violet-500/30";
      case "rare":
        return "text-blue-400 bg-blue-900/20 border-blue-500/30";
      case "common":
        return "text-gray-400 bg-gray-900/20 border-gray-500/30";
      default:
        return "text-white bg-gray-900/20 border-gray-500/30";
    }
  };
      ...
      <div className="absolute top-6 left-6 right-6 z-20 flex justify-between items-start">
        <div className="tokens-title">
          ...
          <p className="text-white/80 text-lg">
            Reflejo Infinito • Vault Cristalino • Experiencias Inmersivas • Lujo
            Cuántico
          </p>
        </div>
        ...
        <div className="vault-controls">
          ...
          <button
            onClick={() =>
              setViewMode(viewMode === "vault" ? "collection" : "vault")
            }
            className="view-btn"
          >
          ...
          <div className="stats-grid">
            ...
            <div className="stat-item">
              ...
              <span className="stat-value">
                {userCollection.total_experiences}
              </span>
            ...
            <div className="stat-item">
              ...
              <span className="stat-value">
                {userCollection.rarity_achievements.length}
              </span>
        ...
        <div className="absolute bottom-8 right-8 z-20 token-panel">
          <div className="token-header">
            <div
              ...
              style={{
                backgroundColor: selectedToken.token_color + "30",
                borderColor: selectedToken.token_color,
              }}
            >
            ...
            <div className="token-info">
              <div className="flex items-center gap-2 mb-2">
                <span
                  className={`rarity-badge ${getRarityColor(selectedToken.rarity)}`}
                >
          ...
          <div className="immersive-preview">
            ...
            <div className="experience-details">
              ...
              <div className="detail-row">
                ...
                <span className="text-sm text-white/80">
                  {selectedToken.experience_duration}
                </span>
              </div>
              <div className="detail-row">
