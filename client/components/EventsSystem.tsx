...
export default function EventsSystem({ events, userLevel }: EventsSystemProps) {
  ...
  const eventTypes = [
    { id: "all", label: "Todos", icon: Calendar, count: events.length },
    {
      ...
      label: "Webinars",
      icon: Presentation,
      count: events.filter((e) => e.type === "webinar").length,
    },
    {
      id: "vr-tour",
      label: "Tours VR Grupales",
      icon: Eye,
      count: events.filter((e) => e.type === "vr-tour").length,
    },
    {
      id: "meetup",
      label: "Meetups",
      icon: Coffee,
      count: events.filter((e) => e.type === "meetup").length,
    },
    {
      id: "workshop",
      label: "Talleres",
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div>
          ...
          <p className="text-white/70">
            Webinars, tours VR grupales y meetups presenciales
          </p>
        </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex space-x-2">
                        ...
                        {canAccess ? (
                          <button
                            onClick={() =>
                              event.isRegistered ? joinEvent(event) : null
                            }
