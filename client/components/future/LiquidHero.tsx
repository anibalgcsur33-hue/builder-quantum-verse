    ...
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 pt-20 pb-16 md:pt-28 md:pb-24">
        ...
        <p className="mt-6 max-w-2xl text-white/70">
          Experiencias inmersivas, inversión inteligente y acceso a un metaverso
          inmobiliario real. VR, AR y Concierge IA, todo en una sola plataforma.
        </p>

        <div className="mt-8 flex gap-4">
          <a href="#vr" className="btn-sheen">
            Explorar en VR
          </a>
          <a
            href="#props"
