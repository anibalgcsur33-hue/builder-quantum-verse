...
export default function HeatmapLegend({
  ...
  const getLayerTitle = (type: string) => {
    switch (type) {
      case "price":
        return "Precio por m²";
      case "tourism":
        return "Ocupación Turística";
      case "demand":
        return "Demanda del Mercado";
      default:
        return type;
    }
  };
  ...
  return (
    <div className={`absolute ${getPositionClasses()} z-30 ${className}`}>
          ...
          <div className="p-4 space-y-4">
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <span
                        className={`font-medium text-sm ${layer.visible ? "text-white" : "text-white/60"}`}
                      >
                    ...
                    <>
                      ...
                      <div className="space-y-2 mb-3">
                        <div
                          ...
                          style={{
                            background: getGradientBackground(layer.colors),
                          }}
                        ></div>
                        <div className="flex justify-between text-xs text-white/60">
                          ...
                          <span>
                            {formatValue(
                              (layer.minValue + layer.maxValue) / 2,
                              layer.unit,
                            )}
                          </span>
                      ...
                      <div className="mt-3 pt-3 border-t border-white/10">
                        <button
                          onClick={() =>
                            setSelectedLayer(
                              selectedLayer === layer.type ? null : layer.type,
                            )
                          }
                            ...
                            <div className="grid grid-cols-3 gap-2 text-xs">
                              <div className="text-center">
                                ...
                                <div className="text-white/60">
                                  {formatValue(layer.minValue, layer.unit)}
                                </div>
                              </div>
                              <div className="text-center">
                                <div className="text-white font-medium">
                              ...
                              <div className="text-center">
                                ...
                                <div className="text-white/60">
                                  {formatValue(layer.maxValue, layer.unit)}
                                </div>
                              </div>
                            </div>
                          </div>
            ...
            <div className="pt-3 border-t border-white/10">
              <div className="flex justify-between gap-2">
                <button
                  onClick={() =>
                    layers.forEach((layer) => onLayerToggle(layer.type, true))
                  }
                ...
                <button
                  onClick={() =>
                    layers.forEach((layer) => onLayerToggle(layer.type, false))
                  }
                  className="flex-1 btn-secondary text-xs py-2"
                >
                  Ocultar Todas
            ...
            <div className="bg-white/5 rounded-lg p-2">
              <div className="flex items-start space-x-2">
                ...
                <div className="text-xs text-white/60">
                  Datos actualizados en tiempo real desde OpenStreetMap, INE y
                  fuentes verificadas. Última actualización:{" "}
      ...
      {layers.some(
        (layer) => layer.visible && layer.currentValue !== undefined,
      ) && (
