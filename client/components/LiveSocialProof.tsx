  ...
  return (
    <>
      ...
      {currentNotification && (
        ...
        >
          <div
            className={`glass-card border rounded-2xl p-4 max-w-sm shadow-xl backdrop-blur-md ${getActionColor(
              ...
              <div className="flex items-start space-x-3 flex-1">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-white/90">
                    ...
                    {currentNotification.propertyType} en{" "}
                  ...
                  <div className="flex items-center space-x-2 mt-2">
                    ...
                    <span className="text-xs text-white/70">
                      Hace{" "}
                      {Math.floor(
                        (Date.now() - currentNotification.timestamp.getTime()) /
                          1000,
                      )}
                      s
                    </span>
