      ...
      <div className="container-xl grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="text-white/70">
            Visualizamos la red de preferencias, emociones y señales de mercado
            como un tejido vivo. La IA ajusta las recomendaciones antes de que
            el usuario lo pida.
          </p>
          ...
          <div className="mt-6 flex gap-3">
            <a className="btn-crystal" href="/ai">
              Probar IA Concierge
            </a>
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            <div className="absolute text-white/60 text-sm bottom-4">
              Capa visual de red neurológica (demo)
            </div>
          </div>
        </motion.div>
      </div>
