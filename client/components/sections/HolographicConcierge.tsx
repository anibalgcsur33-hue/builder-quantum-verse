  ...
  return (
    <section className="section">
      <div className="container-xl grid lg:grid-cols-2 gap-10 items-center">
        <div>
          <h3 className="text-2xl md:text-3xl font-bold mb-4">Concierge IA holográfico</h3>
          <p className="text-white/70">
            Un asistente 24/7 que comprende tus preferencias y te guía con precisión.
            Genera dossiers PDF, agenda visitas y conecta con partners legales.
          </p>
          <div className="mt-6 flex gap-3">
            <a href="/ai" className="btn-crystal">Hablar con IA</a>
        ...
        >
          ...
          <div className="absolute bottom-4 left-4 text-xs text-white/70">Simulación visual del avatar holográfico</div>
        </motion.div>
      </div>
    </section>
  );
