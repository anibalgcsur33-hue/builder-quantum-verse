  ...
  return (
    <section className="section bg-[#0e1628]">
      <div className="container-xl">
        <h3 className="text-2xl md:text-3xl font-bold text-center mb-10">Confianza de inversores</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {stats.map((s) => (
            <div key={s.label} className="glass p-6 rounded-2xl ring-glow text-center">
