    ...
    <section className="section">
      <div className="container-xl">
        <div className="flex items-center justify-between mb-8">
          <h3 className="text-2xl md:text-3xl font-bold">Selección premium</h3>
            ...
            >
              ...
              <div className="mt-4 flex gap-2">
                <button
                  ...
                  onClick={() =>
                    window.alert(`🎯 Demo Tour 360° para ${it.title}`)
                  }
                >
                  <svg
                    className="w-3 h-3"
                ...
                <button
                  ...
                  onClick={() =>
                    window.alert(`🤖 IA Concierge disponible para ${it.title}`)
                  }
                >
                  <svg
                    className="w-3 h-3"
