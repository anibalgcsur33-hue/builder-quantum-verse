      ...
      <div className="container-xl grid lg:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <p className="text-white/70">
            Vista previa ligera del efecto de portal. La versión completa
            integra modelos FBX/GLB y control de cámara.
          </p>
          <div className="mt-6 flex gap-3">
            <a className="btn-crystal" href="/metaverse">
              Entrar al Metaverso
            </a>
        ...
        <div className="relative h-72 glass ring-glow rounded-2xl overflow-hidden flex items-center justify-center">
          <div
            ...
            style={{
              background:
                "conic-gradient(from 0deg, rgba(57,199,255,.6), rgba(167,139,250,.6), rgba(57,199,255,.6))",
              filter: "blur(0.5px)",
            }}
          >
