...
export default function Advanced3DMap({
  ...
  const [currentView, setCurrentView] = useState<
    "globe" | "spain" | "canaries" | "island" | "city"
  >("globe");
  const [selectedProperty, setSelectedProperty] = useState<Property3D | null>(
    null,
  );
  const [heatmapLayer, setHeatmapLayer] = useState<
    "price" | "tourism" | "demand" | null
  >("price");
    ...
    <div className={`relative w-full h-full ${className}`}>
        ...
        <div className="absolute inset-0 bg-blue-dark flex items-center justify-center z-50">
          <div className="text-center">
            ...
            <p className="text-white/70 mb-4">
              Inicializando motor WebGL y cargando tiles...
            </p>
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-20">
        <div className="glass-card px-4 py-2 rounded-lg">
          <div className="text-white/70 text-sm">
            Vista actual:{" "}
            <span className="text-neon-teal font-medium capitalize">
              {currentView}
            </span>
            {isAnimating && (
