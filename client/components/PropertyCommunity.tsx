...
export default function PropertyCommunity({
  ...
  const questionCategories = [
    ...
    },
    {
      id: "legal",
      label: "Legal",
      count: questions.filter((q) => q.category === "legal").length,
    },
    {
      id: "financial",
      label: "Financiero",
      count: questions.filter((q) => q.category === "financial").length,
    },
    {
      id: "neighborhood",
      label: "Vecindario",
      count: questions.filter((q) => q.category === "neighborhood").length,
    },
    {
      id: "technical",
      label: "Técnico",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-white/70">
            Preguntas, respuestas y reseñas de la comunidad
          </p>
        </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h4 className="font-bold text-white">
                Visita la propiedad para dejar una reseña
              </h4>
              <p className="text-white/70">
                Para mantener la calidad de las reseñas, solo los usuarios que
                han visitado la propiedad (presencial o VR) pueden escribir
                reseñas verificadas.
              </p>
            </div>
          </div>
