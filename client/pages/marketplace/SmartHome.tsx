  ...
  const providers: SmartHomeProvider[] = [
    {
      ...
      category: 'automation',
      description: 'Especialistas en domótica integral y automatización del hogar. Sistemas inteligentes para propiedades de lujo.',
      rating: 4.9,
      reviews: 127,
      priceRange: '€5,000 - €25,000',
      image: '/placeholder.svg',
      services: ['Instalación completa', 'Configuración sistemas', 'Mantenimiento', 'Soporte 24/7'],
    ...
    },
    {
      ...
      category: 'security',
      description: 'Sistemas de seguridad avanzados con IA. Cámaras 4K, alarmas inteligentes y control de acceso biométrico.',
      rating: 4.8,
      reviews: 89,
      ...
      warranty: '3 años',
      location: 'Las Palmas',
      specialties: ['Detección IA', 'Reconocimiento facial', 'Análisis comportamiento'],
      featured: false,
      blueEyePartner: true
    },
    {
      ...
      name: 'ClimaTech Pro',
      category: 'climate',
      description: 'Control inteligente de climatización. Termostatos WiFi, zonificación automática y eficiencia energética.',
      rating: 4.7,
      reviews: 156,
      priceRange: '€2,500 - €12,000',
      image: '/placeholder.svg',
      services: ['Termostatos inteligentes', 'Zonificación', 'Control remoto', 'Análisis consumo'],
      certifications: ['Nest Pro', 'Honeywell Partner', 'Tado Installer'],
      installationTime: '1-2 días',
      warranty: '2 años',
      location: 'Costa Adeje',
      specialties: ['Eficiencia energética', 'Geolocalización', 'Programación IA'],
      featured: false,
    ...
    },
    {
      ...
      category: 'lighting',
      description: 'Iluminación inteligente LED. Escenas automáticas, control circadiano y ahorro energético hasta 80%.',
      rating: 4.9,
      reviews: 203,
      priceRange: '€1,500 - €8,000',
      image: '/placeholder.svg',
      services: ['LED inteligente', 'Escenas automáticas', 'Control circadiano', 'Dimming automático'],
      certifications: ['Philips Hue Pro', 'LIFX Partner', 'Lutron Dealer'],
      installationTime: '1 día',
      warranty: '3 años',
      location: 'Puerto de la Cruz',
      specialties: ['Ritmo circadiano', 'Eficiencia LED', 'Diseño personalizado'],
      featured: true,
      blueEyePartner: true
    },
    {
      ...
      description: 'Sistemas multimedia avanzados. Audio multizona, cine en casa 8K y streaming de alta fidelidad.',
      rating: 4.8,
      reviews: 94,
      priceRange: '€4,000 - €30,000',
      image: '/placeholder.svg',
      services: ['Audio multizona', 'Cine en casa', 'Streaming 8K', 'Control unificado'],
      certifications: ['Sonos Pro', 'Bose Professional', 'KEF Partner'],
      installationTime: '2-5 días',
      warranty: '4 años',
      location: 'Arona',
      specialties: ['Alta fidelidad', 'Acústica profesional', 'Integración total'],
      featured: false,
      blueEyePartner: true
    },
    {
      ...
      category: 'energy',
      description: 'Gestión inteligente de energía. Monitoreo consumo, optimización automática y integración solar.',
      rating: 4.6,
      reviews: 67,
      priceRange: '€2,000 - €10,000',
      image: '/placeholder.svg',
      services: ['Monitoreo energía', 'Optimización automática', 'Integración solar', 'Baterías inteligentes'],
      certifications: ['Tesla Powerwall', 'SolarEdge Partner', 'Victron Dealer'],
        ...
        <div className="container mx-auto container-padding">
          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-neon-teal font-medium">Domótica & Automatización</p>
              </div>
            </div>
            <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
              Transforma tu propiedad en un hogar inteligente. Desde sistemas de seguridad avanzados hasta 
              automatización completa del hogar con IA.
            </p>
          ...
          <section className="mb-12">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-white">Partners Destacados</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {featuredProviders.map((provider) => (
                <div key={provider.id} className="glass-card p-6 rounded-2xl border border-neon-teal/20 hover-glow-teal">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 mb-2">
                        ...
                        <div className="text-neon-teal text-sm font-medium">{provider.priceRange}</div>
                      </div>
                  ...
                  >
                    <IconComponent 
                      className={`w-8 h-8 mx-auto mb-2 ${
                        selectedCategory === category.id ? 'text-neon-teal' : 'text-white/70'
                      }`} 
                    />
                    <div className={`font-medium text-sm ${
                      selectedCategory === category.id ? 'text-neon-teal' : 'text-white'
                    }`}>
                      {category.label}
                    </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-3 mb-4">
                      <div className="flex justify-between">
                        <span className="text-white/60 text-sm">Rango precios:</span>
                        <span className="text-neon-teal font-medium text-sm">{provider.priceRange}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-white/60 text-sm">Instalación:</span>
                        <span className="text-white text-sm">{provider.installationTime}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-white/60 text-sm">Garantía:</span>
                        <span className="text-white text-sm">{provider.warranty}</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-white/60 text-sm">Ubicación:</span>
                        <div className="flex items-center space-x-1">
                          <MapPin className="w-3 h-3 text-white/60" />
                          <span className="text-white text-sm">{provider.location}</span>
                        </div>
                      </div>
                    </div>

                    <div className="mb-4">
                      <h4 className="text-white font-medium text-sm mb-2">Servicios:</h4>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {provider.specialties.map((specialty, index) => (
                          <span key={index} className="bg-neon-teal/20 text-neon-teal px-2 py-1 rounded text-xs">
                            {specialty}
                          </span>
                        ))}
                      </div>
