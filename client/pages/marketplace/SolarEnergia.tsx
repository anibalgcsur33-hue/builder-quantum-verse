  ...
  const providers: SolarProvider[] = [
    {
      ...
      description: 'Líderes en energía solar residencial. Instalaciones premium para villas y propiedades de lujo con garantía de 25 años.',
      rating: 4.9,
      reviews: 234,
      priceRange: '€8,000 - €35,000',
      image: '/placeholder.svg',
      services: ['Instalación solar', 'Baterías Tesla', 'Monitoreo IoT', 'Mantenimiento'],
      certifications: ['Tesla Powerwall Certified', 'SolarEdge Partner', 'ISO 9001'],
    ...
    },
    {
      ...
      category: 'commercial',
      description: 'Especialistas en instalaciones solares comerciales e industriales. Proyectos a gran escala con ROI garantizado.',
      rating: 4.8,
      reviews: 167,
      priceRange: '€25,000 - €150,000',
      image: '/placeholder.svg',
      services: ['Solar comercial', 'Proyectos industriales', 'Financiación', 'O&M'],
    ...
    },
    {
      ...
      category: 'residential',
      description: 'Soluciones sostenibles integrales. Solar + aerotermia + domótica para la máxima eficiencia energética.',
      rating: 4.7,
      reviews: 189,
      priceRange: '€12,000 - €45,000',
      image: '/placeholder.svg',
      services: ['Solar híbrido', 'Aerotermia', 'Domótica', 'Auditoría energética'],
    ...
    },
    {
      ...
      category: 'batteries',
      description: 'Especialistas en sistemas de almacenamiento. Baterías de litio de última generación con gestión inteligente.',
      rating: 4.8,
      reviews: 98,
      priceRange: '€5,000 - €20,000',
      image: '/placeholder.svg',
      services: ['Baterías litio', 'Gestión inteligente', 'Backup total', 'Monitoreo 24/7'],
    ...
    },
    {
      ...
      description: 'Mantenimiento especializado y optimización de instalaciones solares. Servicio 24/7 con drones de inspección.',
      rating: 4.9,
      reviews: 145,
      priceRange: '€200 - €800/año',
      image: '/placeholder.svg',
      services: ['Mantenimiento preventivo', 'Inspección con drones', 'Limpieza automática', 'Optimización'],
      certifications: ['IEA PVPS', 'NREL Certified', 'ISO 14001'],
      installationTime: '1 día',
      warranty: '5 años',
      location: 'Puerto de la Cruz',
      specialties: ['Drones inspección', 'Limpieza robótica', 'Análisis predictivo'],
      featured: false,
      blueEyePartner: false,
        ...
        <div className="container mx-auto container-padding">
          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-yellow-400 font-medium">Sostenibilidad & Ahorro</p>
              </div>
            </div>
            <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
              Aprovecha el sol de Canarias. Instalaciones solares de última generación con hasta 90% de ahorro 
              energético y ROI garantizado.
            </p>
            ...
            <div className="glass-card p-6 rounded-2xl border border-yellow-400/20 bg-gradient-to-r from-yellow-400/10 to-orange-500/10">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white">Calculadora Solar Instantánea</h3>
                    <p className="text-white/70 text-sm">Descubre tu potencial de ahorro en 30 segundos</p>
                  </div>
                </div>
                <button 
              ...
              {showCalculator && (
                <div className="border-t border-white/10 pt-6 mt-6">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                      <label className="block text-white/70 mb-2 text-sm">Factura mensual €</label>
                      <input 
                        type="number" 
                        placeholder="150"
                    ...
                    <div>
                      <label className="block text-white/70 mb-2 text-sm">m² de tejado</label>
                      <input 
                        type="number" 
                        placeholder="100"
                        className="w-full bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-white"
                    ...
                    <div>
                      <label className="block text-white/70 mb-2 text-sm">Orientación</label>
          ...
          <section className="mb-12">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-white">Instaladores Certificados</h2>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {featuredProviders.map((provider) => (
                <div key={provider.id} className="glass-card p-6 rounded-2xl border border-yellow-400/20 hover-glow">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-3">
                        ...
                        <div className="text-yellow-400 text-sm font-medium">{provider.powerRange}</div>
                        <div className="flex items-center space-x-1">
                          <TrendingUp className="w-4 h-4 text-green-400" />
                          <span className="text-green-400 text-sm">{provider.avgSavings}% ahorro</span>
                        </div>
                        <div className="flex items-center space-x-1">
                          <CheckCircle className="w-4 h-4 text-green-400" />
                          <span className="text-white/70 text-sm">{provider.completedProjects} proyectos</span>
                        </div>
                      </div>
                      <p className="text-white/70 text-sm mb-3">{provider.description}</p>
                      <div className="flex justify-between items-center">
                        <div className="text-yellow-400 font-medium">{provider.priceRange}</div>
          ...
          {/* Benefits Section */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-6 text-center">¿Por qué Energía Solar en Canarias?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="glass-card p-6 rounded-xl text-center">
                ...
                <p className="text-white/70 text-sm">350+ días de sol al año. Irradiación solar óptima todo el año.</p>
              </div>
              <div className="glass-card p-6 rounded-xl text-center">
                <Euro className="w-12 h-12 text-green-400 mx-auto mb-4" />
                <h3 className="font-bold text-white mb-2">ROI 6-8 años</h3>
                <p className="text-white/70 text-sm">Retorno de inversión garantizado. Ahorro inmediato en factura.</p>
              </div>
              <div className="glass-card p-6 rounded-xl text-center">
                <Leaf className="w-12 h-12 text-green-500 mx-auto mb-4" />
                <h3 className="font-bold text-white mb-2">100% Limpia</h3>
                <p className="text-white/70 text-sm">Reduce tu huella de carbono hasta 3 toneladas CO₂/año.</p>
              </div>
              <div className="glass-card p-6 rounded-xl text-center">
                <TrendingUp className="w-12 h-12 text-blue-400 mx-auto mb-4" />
                <h3 className="font-bold text-white mb-2">Valor Inmueble</h3>
                <p className="text-white/70 text-sm">Incrementa el valor de tu propiedad hasta un 15%.</p>
              </div>
            </div>
          </section>
                  ...
                  >
                    <IconComponent 
                      className={`w-8 h-8 mx-auto mb-2 ${
                        selectedCategory === category.id ? 'text-yellow-400' : 'text-white/70'
                      }`} 
                    />
                    <div className={`font-medium text-sm ${
                      selectedCategory === category.id ? 'text-yellow-400' : 'text-white'
                    }`}>
                      {category.label}
                    </div>
                    <div className="text-xs text-white/60 mt-1">{category.count}</div>
                  </button>
                );
              })}
            </div>
          ...
          <section>
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
              {filteredProviders.map((provider) => (
                <div key={provider.id} className="glass-card rounded-2xl overflow-hidden hover-glow transition-all duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4">
                      <div className="glass p-2 rounded text-center">
                        <div className="text-green-400 font-bold">{provider.avgSavings}%</div>
                        <div className="text-xs text-white/60">Ahorro</div>
                      </div>
                      <div className="glass p-2 rounded text-center">
                        <div className="text-white font-bold">{provider.completedProjects}</div>
                    ...
                    <div className="space-y-2 mb-4">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-yellow-400 font-medium">{provider.priceRange}</span>
                      </div>
                      <div className="flex justify-between text-sm">
