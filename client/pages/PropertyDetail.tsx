                      ...
                      questions={[
                        {
                          ...
                          answer:
                            "Los gastos de comunidad son de aproximadamente 180€ mensuales, que incluyen mantenimiento de zonas comunes, piscina, jardines y seguridad.",
                          author: {
                            name: "María González",
                            avatar: "/placeholder.svg",
                            level: "comprador-pro",
                        ...
                        },
                        {
                          id: "2",
                          question:
                            "¿Es posible hacer alquiler vacacional en esta propiedad?",
                          answer:
                            "Sí, la comunidad permite alquiler vacacional. Sin embargo, requiere registro en el ayuntamiento y cumplir con la normativa turística de Canarias.",
                          author: {
                            name: "Pedro López",
                            avatar: "/placeholder.svg",
                            level: "explorador",
                        ...
                        },
                        {
                          id: "3",
                          question:
                            "¿Cómo está la conectividad a internet en la zona?",
                          author: {
                            name: "Sophie Dubois",
                            avatar: "/placeholder.svg",
                            level: "comprador-pro",
                      ...
                      reviews={[
                        {
                          ...
                          content:
                            "Visitamos esta villa el mes pasado y quedamos impresionados. Las vistas al océano son realmente únicas y la calidad de los acabados es excepcional. La distribución es muy práctica para una familia.",
                          author: {
                            name: "Hans Mueller",
                            avatar: "/placeholder.svg",
                        ...
                        },
                        {
                          ...
                          content:
                            "La propiedad tiene mucho potencial para alquiler vacacional. La zona es muy demandada y las características de la villa la hacen muy atractiva para turistas de alto nivel.",
                          author: {
                            name: "Carmen Silva",
                            avatar: "/placeholder.svg",
                            level: "comprador-pro",
