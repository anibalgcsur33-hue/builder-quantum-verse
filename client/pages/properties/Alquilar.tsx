...
export default function Alquilar() {
  ...
  const [activeTab, setActiveTab] = useState<'vacacional' | 'larga-temporada'>('vacacional');
  ...
  const properties: RentalProperty[] = [
    {
      ...
      description: 'Villa de lujo con piscina privada y vistas panorámicas al océano. Perfecta para vacaciones familiares exclusivas.',
      category: 'Villa',
      verified: true,
      featured: true,
      ...
      amenities: ['Piscina privada', 'Wifi', 'Aire acondicionado', 'Cocina completa', 'Barbacoa', 'Parking'],
      nearbyAttractions: ['Playa del Duque', 'Centro Comercial', 'Campo de Golf'],
      occupancyRate: 85,
      rating: 4.9,
      reviews: 127,
      instantBook: true,
    ...
    },
    {
      ...
      description: 'Moderno apartamento en el centro de Las Palmas, ideal para profesionales o estudiantes. Totalmente amueblado.',
      ...
      nearbyAttractions: ['Universidad', 'Transporte público', 'Zona comercial'],
      rating: 4.5,
      reviews: 34,
      instantBook: false,
      petFriendly: true,
    ...
    },
    {
      ...
      description: 'Ático con terraza panorámica en primera línea de puerto. Disponible tanto para estancias cortas como largas.',
      category: 'Penthouse',
      verified: true,
      featured: true,
      rentalType: 'ambos',
      ...
      amenities: ['Terraza', 'Vista puerto', 'Wifi', 'Cocina', 'Parking', 'Ascensor'],
    ...
    },
    {
      ...
      sqm: 150,
      images: ['/placeholder.svg', '/placeholder.svg'],
      description: 'Auténtica casa canaria en zona rural tranquila. Perfecta para desconectar y disfrutar de la naturaleza.',
      category: 'Casa Rural',
      verified: true,
      featured: false,
      rentalType: 'vacacional',
      ...
      amenities: ['Jardín', 'Barbacoa', 'Parking', 'Wifi', 'Chimenea', 'Vistas montaña'],
    ...
    },
    {
      ...
      sqm: 45,
      images: ['/placeholder.svg'],
      description: 'Estudio completamente renovado a 50m de la playa. Ideal para parejas o viajeros individuales.',
      category: 'Estudio',
      verified: false,
      featured: false,
      rentalType: 'ambos',
      ...
      amenities: ['Cerca playa', 'Wifi', 'Aire acondicionado', 'Cocina', 'Balcón'],
  ...
  const filteredProperties = properties.filter(property => {
    const matchesTab = activeTab === 'vacacional' 
      ? property.rentalType === 'vacacional' || property.rentalType === 'ambos'
      : property.rentalType === 'larga-temporada' || property.rentalType === 'ambos';
  ...
  const getRateDisplay = (property: RentalProperty) => {
    if (activeTab === 'vacacional') {
      return property.dailyRate ? `${formatCurrency(property.dailyRate)}/día` : 'Consultar precio';
    } else {
      return property.monthlyRate ? `${formatCurrency(property.monthlyRate)}/mes` : 'Consultar precio';
    }
  };
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-blue-400 font-medium">Vacacional y larga temporada en Canarias</p>
              </div>
            </div>
            <p className="text-white/70 text-lg max-w-2xl">
              Desde escapadas de ensueño hasta estancias prolongadas. Encuentra el alquiler perfecto 
              para tus necesidades con precios transparentes y reserva inmediata.
            </p>
          </div>
            ...
            {showFilters && (
              <div className="border-t border-white/10 pt-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  {activeTab === 'vacacional' && (
                    <div>
                      <label className="block text-white/70 mb-2 text-sm">Huéspedes</label>
                      <select
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-xl font-bold text-white">
                {filteredProperties.length} propiedades para alquiler {activeTab === 'vacacional' ? 'vacacional' : 'larga temporada'}
              </h2>
              ...
              <div key={property.id} className={`glass-card rounded-2xl overflow-hidden hover-glow transition-all duration-300 ${
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="flex justify-between items-center">
                      <div className="glass-card px-3 py-1 rounded-lg backdrop-blur-md">
                        <span className="text-white font-bold">{getRateDisplay(property)}</span>
                      </div>
                      {property.rating && (
                ...
                <div className={`p-6 ${viewMode === 'list' ? 'flex-1' : ''}`}>
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-4">
                    ...
                    <div className="text-center">
                      <div className="flex items-center justify-center space-x-1">
                        {activeTab === 'vacacional' ? <Users className="w-4 h-4 text-white/60" /> : <Square className="w-4 h-4 text-white/60" />}
                        <span className="text-white font-medium">
                          {activeTab === 'vacacional' ? property.maxGuests : property.sqm}
                        </span>
                      </div>
                  ...
                  <div className="flex flex-wrap gap-1 mb-4">
                    ...
                    {property.amenities.length > 3 && (
                      <span className="text-white/60 text-xs">+{property.amenities.length - 3} más</span>
                    )}
                  </div>

                  <div className="flex justify-between items-center">
                    <div className="text-sm text-white/60">
                      <div>Mín. {property.minimumStay} {property.minimumStay === 1 ? 'día' : property.minimumStay < 30 ? 'días' : 'mes'}</div>
