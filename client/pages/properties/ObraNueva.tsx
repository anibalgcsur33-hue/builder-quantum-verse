...
export default function ObraNueva() {
  ...
  const developments: NewDevelopment[] = [
    {
      ...
      description:
        "Complejo residencial de lujo con diseño sostenible y vistas panorámicas al océano. Apartamentos y áticos con las últimas tecnologías.",
    ...
    },
    {
      ...
      description:
        "Exclusivas villas independientes con piscina privada y jardín. Diseño mediterráneo moderno con acabados de primera calidad.",
      category: "Villas",
      verified: true,
      featured: true,
      energyRating: "A",
    ...
    },
    {
      ...
      description:
        "Moderno complejo residencial frente al puerto deportivo. Apartamentos de 1 a 3 dormitorios con vistas al mar y la ciudad.",
      category: "Residencial",
      verified: true,
      featured: false,
      energyRating: "B+",
      ...
      sustainability: [
        ...
        "LED en zonas comunes",
        "Reciclaje agua",
      ],
      smartFeatures: [
        "Pre-instalación domótica",
        "Fibra óptica",
        "Videoportero",
      ],
      financing: true,
    ...
    },
    {
      ...
      images: ["/placeholder.svg", "/placeholder.svg"],
      description:
        "Promoción de viviendas eco-sostenibles con vistas al Teide. Construcción bioclimática con materiales naturales.",
  ...
  const filteredDevelopments = developments.filter((dev) => {
    ...
    const matchesPriceMin =
      !filters.priceMin || dev.priceFrom >= parseInt(filters.priceMin);
    const matchesPriceMax =
      !filters.priceMax || dev.priceFrom <= parseInt(filters.priceMax);
  ...
  const getDeliveryStatus = (deliveryDate: string) => {
    ...
    const now = new Date();
    const monthsUntilDelivery = Math.ceil(
      (delivery.getTime() - now.getTime()) / (1000 * 60 * 60 * 24 * 30),
    );

    if (monthsUntilDelivery <= 6)
      return { text: "Entrega inmediata", color: "text-green-400" };
    if (monthsUntilDelivery <= 12)
      return { text: "Entrega próxima", color: "text-yellow-400" };
        ...
        <div className="container mx-auto container-padding">
            ...
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-orange-400 font-medium">
                  Promociones exclusivas en construcción
                </p>
              </div>
            </div>
            <p className="text-white/70 text-lg max-w-2xl">
              Descubre las mejores promociones de obra nueva en Canarias. Desde
              villas de lujo hasta residenciales eco-sostenibles con las últimas
              tecnologías y precios de lanzamiento.
            </p>
          </div>
          ...
          <div className="glass-card p-6 rounded-2xl mb-8 bg-gradient-to-r from-orange-500/10 to-pink-500/10 border border-orange-500/20">
            <h3 className="text-xl font-bold text-white mb-4">
              Ventajas de comprar en obra nueva
            </h3>
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-white/60 text-sm">
                Con precios desde{" "}
                {formatCurrency(
                  Math.min(...developments.map((d) => d.priceFrom)),
                )}
              </p>
            </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div className="glass-card px-3 py-1 rounded-lg backdrop-blur-md">
                        <span className="text-white font-bold">
                          Desde {formatCurrency(development.priceFrom)}
                        </span>
                      </div>
                      <div
                        className={`${getDeliveryStatus(development.deliveryDate).color} text-sm font-medium`}
                      >
                ...
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="text-white">
                        {development.constructionProgress}%
                      </span>
                    </div>
                    <div className="w-full bg-white/10 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${development.constructionProgress}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="text-sm text-white/60">
                      <div>
                        Entrega:{" "}
                        {new Date(development.deliveryDate).toLocaleDateString(
                          "es-ES",
                        )}
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="glass-card p-6 rounded-2xl text-center">
              ...
              <p className="text-white/70 text-sm">
                10 años de garantía estructural y 2 años en acabados
              </p>
            </div>
            <div className="glass-card p-6 rounded-2xl text-center">
              ...
              <p className="text-white/70 text-sm">
                Hasta 90% financiación con nuestros partners bancarios
              </p>
            </div>
            <div className="glass-card p-6 rounded-2xl text-center">
              ...
              <p className="text-white/70 text-sm">
                Elige acabados y mejoras según tu estilo
              </p>
            </div>
          </div>
        </div>
