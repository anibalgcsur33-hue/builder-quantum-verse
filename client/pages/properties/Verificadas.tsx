...
export default function Verificadas() {
  ...
  const properties: VerifiedProperty[] = [
    {
      ...
      description: 'Villa de lujo completamente verificada con documentación legal al día y valoración profesional.',
      category: 'Villa',
      ...
      legalCheck: {
        status: 'approved',
        details: 'Documentación completa y sin cargas. Propiedad libre de gravámenes.'
      },
      inspection: {
        score: 95,
        date: '2024-01-10',
      ...
      features: ['Piscina privada', 'Vista panorámica', 'Garaje doble', 'Jardín', 'Terraza 80m²'],
    ...
    },
    {
      ...
      description: 'Ático en primera línea con verificación premium y garantía legal completa.',
      category: 'Penthouse',
      ...
      features: ['Terraza panorámica', 'Plaza parking', 'Trastero', 'Ascensor', 'Conserje'],
    ...
    },
    {
      ...
      description: 'Casa tradicional canaria con licencia turística verificada y documentación completa.',
      category: 'Casa Rural',
      ...
      inspection: {
        ...
        report: 'Estructura tradicional bien conservada. Reformas necesarias menores.'
      },
      marketAnalysis: {
        fairValue: 520000,
        appreciation: 15,
      ...
      features: ['Licencia turística', 'Patio canario', 'Barbacoa', 'Parking', 'WiFi'],
    ...
    },
    {
      ...
      sqm: 80,
      images: ['/placeholder.svg', '/placeholder.svg'],
      description: 'Apartamento ideal para inversión con documentación verificada y análisis de rentabilidad.',
      ...
      legalCheck: {
        status: 'approved',
        details: 'Sin cargas. Comunidad solvente. Ideal para alquiler turístico.'
      },
      inspection: {
        score: 82,
        date: '2024-01-26',
        inspector: 'Tasador Homologado',
        report: 'Estado correcto. Reformado recientemente. Listo para alquilar.'
      },
      marketAnalysis: {
        fairValue: 280000,
        appreciation: 10,
      ...
      features: ['Reformado', 'Amueblado', 'Balcón', 'Cerca playa', 'Comunidad piscina'],
  ...
  const filteredProperties = properties.filter(property => {
    ...
    const matchesLevel = selectedLevel === 'all' || property.verificationLevel === selectedLevel;
        ...
        <div className="container mx-auto container-padding">
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-purple-400 font-medium">Garantía legal y técnica completa</p>
              </div>
            </div>
            <p className="text-white/70 text-lg max-w-2xl">
              Todas nuestras propiedades verificadas han pasado rigurosos controles legales, técnicos y de mercado. 
              Compra con total confianza y transparencia.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="glass-card p-6 rounded-2xl text-center border border-blue-500/20">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Verificación Básica</h3>
              <p className="text-white/70 text-sm">Documentación legal, escrituras y cargas verificadas por gestores especializados.</p>
            </div>
            <div className="glass-card p-6 rounded-2xl text-center border border-yellow-500/20">
              <div className="w-16 h-16 bg-yellow-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <Award className="w-8 h-8 text-yellow-400" />
              </div>
              <h3 className="text-lg font-bold text-white mb-2">Verificación Premium</h3>
              <p className="text-white/70 text-sm">Incluye inspección técnica, valoración profesional y análisis de mercado completo.</p>
            </div>
            <div className="glass-card p-6 rounded-2xl text-center border border-purple-500/20">
              <div className="w-16 h-16 bg-purple-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <Star className="w-8 h-8 text-purple-400" />
              </div>
              <h3 className="text-lg font-bold text-white mb-2">Verificación Platinum</h3>
              <p className="text-white/70 text-sm">Máximo nivel: auditoría completa, certificaciones, garantía legal y seguro de compra.</p>
            </div>
          </div>
          ...
          <div className="mb-8">
            <div className="flex flex-wrap gap-3">
              ...
              >
                💎 Platinum ({properties.filter(p => p.verificationLevel === 'platinum').length})
              </button>
              <button
              ...
              >
                🏆 Premium ({properties.filter(p => p.verificationLevel === 'premium').length})
              </button>
              <button
              ...
              >
                ✓ Básica ({properties.filter(p => p.verificationLevel === 'basic').length})
              </button>
            </div>
          </div>
            ...
            {showFilters && (
              <div className="border-t border-white/10 pt-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div>
                    <label className="block text-white/70 mb-2 text-sm">Trust Score</label>
                    <select
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-white/60 text-sm">Con garantía legal y técnica completa</p>
            </div>
          ...
          <div className={`grid gap-6 mb-12 ${
            ...
            {filteredProperties.map((property) => {
              const verificationBadge = getVerificationBadge(property.verificationLevel);
              return (
                  ...
                  <div className={`relative ${viewMode === 'list' ? 'w-80 h-64' : 'h-64'}`}>
                    ...
                    <div className="absolute top-4 left-4">
                      <div className="flex flex-col gap-2">
                        <div className={`${verificationBadge.color} text-white px-2 py-1 rounded-full text-xs font-bold backdrop-blur-sm flex items-center gap-1`}>
                          <span>{verificationBadge.icon}</span>
                          Verificación {verificationBadge.text}
                        </div>
                        <div className={`bg-black/50 backdrop-blur-sm px-2 py-1 rounded-full text-xs font-medium flex items-center gap-1 ${getTrustColor(property.trustScore)}`}>
                  ...
                  <div className={`p-6 ${viewMode === 'list' ? 'flex-1' : ''}`}>
                    ...
                    <div className="flex items-center space-x-1 mb-4">
                      ...
                      <span className="text-white/70 text-sm">
                        Verificada el {new Date(property.verificationDate).toLocaleDateString('es-ES')}
                      </span>
                    </div>
                    ...
                    <div className="bg-white/5 rounded-lg p-3 mb-4">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-white/80">Documentos: {property.documents.length}/5</span>
                        </div>
                        <div className="flex items-center gap-1">
                          <Scale className="w-3 h-3 text-green-400" />
                          <span className="text-white/80">Legal: {property.legalCheck.status}</span>
                        </div>
                        <div className="flex items-center gap-1">
                          <Eye className="w-3 h-3 text-green-400" />
                          <span className="text-white/80">Inspección: {property.inspection.score}/100</span>
                        </div>
                        <div className="flex items-center gap-1">
                          <TrendingUp className="w-3 h-3 text-green-400" />
                          <span className="text-white/80">Valor justo verificado</span>
                        </div>
                      </div>
                    </div>
          ...
          <div className="glass-card p-8 rounded-2xl text-center mb-12 bg-gradient-to-r from-purple-500/10 to-blue-500/10 border border-purple-500/20">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Garantía BlueEye Homes</h3>
            <p className="text-white/70 max-w-2xl mx-auto mb-6">
              Todas nuestras propiedades verificadas incluyen garantía legal completa. Si encuentras cualquier 
              problema documental no detectado en nuestra verificación, te devolvemos el 100% del precio de compra.
            </p>
