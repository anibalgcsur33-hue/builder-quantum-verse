    ...
    <div className="min-h-screen bg-blue-dark text-white/90 flex items-center justify-center">
      <div className="container mx-auto container-padding text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <h1 className="heading-lg text-gradient mb-6">{title}</h1>

          <p className="text-xl text-white/70 mb-8">{description}</p>

          <div className="glass-card p-6 rounded-xl mb-8">
            <p className="text-white/60">
              Esta página está en desarrollo. Continúa navegando para explorar
              las funcionalidades disponibles o regresa al inicio para descubrir
              más sobre BlueEyeHomes.
            </p>
          </div>
          ...
          <div className="mt-12 p-6 glass-card rounded-xl">
            ...
            <p className="text-white/70 text-sm">
              Estamos construyendo el futuro del real estate en el metaverso. Si
              necesitas acceso a esta función específica, contáctanos y te
