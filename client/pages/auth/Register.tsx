      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="glass-card p-8 rounded-2xl">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            >
              <User
                className={`mx-auto mb-3 ${accountType === "buyer" ? "text-neon-teal" : "text-white/60"}`}
                size={32}
              />
            ...
            >
              <Building
                className={`mx-auto mb-3 ${accountType === "agency" ? "text-neon-emerald" : "text-white/60"}`}
                size={32}
              />
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                />
                <span className="text-white/70 text-sm">
                  Quiero recibir noticias, ofertas especiales y actualizaciones
