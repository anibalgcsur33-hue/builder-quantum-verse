...
export default function Community() {
  ...
  const blogPosts = [
    {
      id: 1,
      title: 'Guía completa para comprar en Canarias: Todo lo que necesitas saber',
      category: 'guias-locales',
      author: 'Carmen Silva',
      authorAvatar: '/placeholder.svg',
      publishDate: '2024-01-15',
      readTime: '8 min',
      excerpt: 'Descubre los aspectos legales, fiscales y prácticos para adquirir tu propiedad en las Islas Canarias.',
    ...
    {
      id: 2,
      title: 'El mercado inmobiliario canario alcanza máximos históricos en 2024',
      category: 'noticias',
      author: 'Miguel Torres',
      authorAvatar: '/placeholder.svg',
      publishDate: '2024-01-20',
      readTime: '5 min',
      excerpt: 'Análisis del crecimiento del 12% en el precio medio de la vivienda en el archipiélago.',
      image: '/placeholder.svg',
    ...
    },
    {
      ...
      readTime: '3 min',
      excerpt: 'Únete a nuestro próximo evento virtual el 30 de enero a las 19:00 CET.',
      image: '/placeholder.svg',
  ...
  const filteredForumTopics = selectedForumCategory === 'all'
    ? forumTopics
      ...
      <div className="container mx-auto container-padding">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Conecta con otros compradores e inversores, comparte experiencias y descubre 
            oportunidades exclusivas en nuestro espacio virtual.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          ...
          <div className="glass-card p-6 text-center hover-glow-teal">
            <MessageSquare className="text-neon-teal mx-auto mb-3" size={32} />
            <div className="text-2xl font-bold">3,892</div>
            <div className="text-white/60 text-sm">Conversaciones</div>
          </div>
          <div className="glass-card p-6 text-center hover-glow-emerald">
            <TrendingUp className="text-neon-emerald mx-auto mb-3" size={32} />
          ...
          <div className="space-y-8">
            ...
            <div className="glass-card p-8 rounded-xl text-center">
              ...
              <p className="text-white/70 mb-6 max-w-2xl mx-auto">
                Únete a otros usuarios explorando propiedades en nuestro metaverso. 
                Comparte tours, haz preguntas en vivo y conecta con la comunidad.
              </p>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {virtualSpaceUsers.map((user) => (
                  <div key={user.id} className="glass-card p-6 hover-glow-teal">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="relative">
                        ...
                        />
                        <div className={`absolute -top-1 -right-1 w-4 h-4 rounded-full border-2 border-blue-dark ${
                          user.status === 'online' ? 'bg-green-500' : 
                          user.status === 'in-tour' ? 'bg-neon-teal' : 'bg-gray-500'
                        }`}></div>
                      </div>
                      <div>
                        <div className="font-bold flex items-center gap-2">
                          {user.name}
                          {user.badge === 'VIP' && <Crown className="text-yellow-500" size={16} />}
                          {user.badge === 'Inversor' && <Badge className="text-neon-emerald" size={16} />}
                        </div>
                    ...
                    {user.currentTour && (
                      <div className="bg-white/5 p-3 rounded-lg">
                        <div className="text-sm text-white/60 mb-1">Explorando:</div>
                        <div className="font-medium text-neon-teal">{user.currentTour}</div>
                      </div>
                    )}
              ...
              <div className="space-y-4">
                <div className="glass-card p-6 hover-glow-emerald">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                      <h4 className="text-xl font-bold mb-2">Tour Grupal: Villas de Lujo en Tenerife</h4>
                      <p className="text-white/70 mb-3">
                        Explora las mejores propiedades de la isla con otros inversores y compradores.
                      </p>
                ...
                <div className="glass-card p-6 hover-glow-teal">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                      <h4 className="text-xl font-bold mb-2">Webinar: Inversión Inmobiliaria en Canarias 2024</h4>
                      <p className="text-white/70 mb-3">
                        Estrategias, oportunidades y análisis de mercado con expertos del sector.
                      </p>
                      <div className="flex items-center gap-4 text-sm text-white/60">
                        <div className="flex items-center gap-1">
                          <Calendar size={16} />
        ...
        {activeTab === 'blog' && (
          <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                <h2 className="text-3xl font-bold text-gradient mb-2">Blog de la Comunidad</h2>
            ...
            <div className="space-y-6">
              {filteredBlogPosts.map((post) => (
                <article key={post.id} className="glass-card p-6 hover-glow-teal">
                    ...
                    <div className="lg:w-2/3">
                      <div className="flex items-center gap-3 mb-3">
                        <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                          post.category === 'guias-locales' ? 'bg-neon-teal/20 text-neon-teal' :
                          post.category === 'noticias' ? 'bg-neon-emerald/20 text-neon-emerald' :
                          'bg-purple-500/20 text-purple-400'
                        }`}>
                          {post.category === 'guias-locales' ? 'Guía Local' :
                           post.category === 'noticias' ? 'Noticia' : 'Evento'}
                        </span>
                        {post.isEvent && (
        ...
        {activeTab === 'forum' && (
          <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                <h2 className="text-3xl font-bold text-gradient mb-2">Foro de la Comunidad</h2>
                <p className="text-white/70">
                  Comparte experiencias y resuelve dudas con otros compradores e inversores
                </p>
              </div>
              <button className="btn-primary flex items-center gap-2">
            ...
            <div className="space-y-4">
              {filteredForumTopics.map((topic) => (
                <div key={topic.id} className="glass-card p-6 hover-glow-teal">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className={`px-2 py-1 rounded text-xs font-semibold ${
                          topic.category === 'compradores' ? 'bg-neon-teal/20 text-neon-teal' :
                          'bg-neon-emerald/20 text-neon-emerald'
                        }`}>
                          {topic.category === 'compradores' ? 'Compradores' : 'Inversores'}
                        </span>
                      </div>
                    ...
                    <div className="text-right text-sm text-white/60">
                      ...
                      <div className="text-xs">
                        Última actividad: {new Date(topic.lastActivity).toLocaleDateString('es-ES')}
                      </div>
                    </div>
                  </div>
                </div>
