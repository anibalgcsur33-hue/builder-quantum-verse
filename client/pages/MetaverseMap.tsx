  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-[radial-gradient(1200px_800px_at_50%_-10%,#1c234d_0%,#0b0f24_40%,#050815_100%)] text-[#eaf3ff]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className={`mx-auto max-w-7xl px-6 ${TUNABLES.heroPadBottom} ${TUNABLES.heroPadTop}`}>
          <div className={`grid grid-cols-1 items-center ${TUNABLES.heroGap} lg:grid-cols-3`}>
            {/* Text */}
            <div className="lg:col-span-2">
              <h1 className="text-4xl font-extrabold leading-tight md:text-5xl">
                Distrito Metaverso de Lujo
                <span className="block text-2xl font-semibold text-[#78e1ff] md:text-3xl">Donde el legado se vuelve inmortal</span>
              </h1>
              <p className="mt-4 max-w-[65ch] text-white/80">
                Accede a la única inversión que trasciende el tiempo: un pasaporte holográfico cuántico que asegura que tu presencia, tu esencia y tus recuerdos vivirán para siempre en el Metaverso. Un mundo donde tus seres queridos nunca perderán tu legado.
              </p>
              <div className="mt-6 flex flex-wrap gap-3">
                <a href="/marketplace?utm_source=metaverso-page" className="rounded-xl border border-white/15 bg-white/10 px-5 py-3 font-semibold backdrop-blur hover:bg-white/20">Explorar Marketplace</a>
                <a href="/comunidad?utm_source=metaverso-page" className="rounded-xl border border-white/15 bg-[#121838] px-5 py-3 font-semibold hover:bg-[#162062]">Conocer Comunidad</a>
              </div>
            ...
            {/* Logo (derecha) */}
            <div className={`flex items-start justify-center lg:justify-end ${TUNABLES.logoShift}`}>
              <img
          ...
          <div className="mt-14 flex flex-col items-center gap-8 lg:mt-16 lg:flex-row lg:justify-center lg:gap-16">
            <HoloPassport
              ...
              seed="REAL-IMMORTAL"
              photoUrl={"https://huvzqqtfgidybxmmbdig.supabase.co/storage/v1/object/public/Media/METAVERSO/blueEyeIA.png"}
              variant="REAL"
            />
            <HoloPassport
              title="Quantum Immortal Passport"
              ...
              seed="META-IMMORTAL"
              photoUrl={"https://huvzqqtfgidybxmmbdig.supabase.co/storage/v1/object/public/Media/METAVERSO/QuantumIA.png"}
              variant="META"
            />
          </div>
        </div>
