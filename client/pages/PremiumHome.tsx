        ...
        <section className="relative min-h-screen flex items-center justify-center pt-28">
          ...
          >
            ...
            <motion.p
              ...
              transition={{ delay: 1 }}
            >
              Experiencias inmersivas, inversión inteligente y acceso a un
              metaverso inmobiliario real con VR, AR y Concierge IA.
            </motion.p>
            ...
            >
              <motion.button
                onClick={() => {
                  ...
                  const vuMeterButton = document.querySelector(
                    '[title="Activar visualizador de voz"]',
        ...
        <section className="relative py-20">
          ...
          >
            <h2 className="text-5xl font-bold text-white mb-6">
              ...
              <span className="text-cyan-400">BlueEyes</span>
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                },
                {
                  ...
                  price: "€5.4M",
                  image:
                    "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
                  location: "Eixample",
                },
                {
          ...
          >
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-white/70 max-w-4xl mx-auto">
                ...
                respuesta IA contextual.
                <br />
                Tecnología del futuro implementada hoy para revolucionar el
                sector inmobiliario.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              ...
              >
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  Canvas 2D ultra-optimizado que responde a tu movimiento. Nodos
                  inteligentes que crean conexiones dinámicas en tiempo real.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  TTS/STT nativo español + WebAudio API. Conversaciones
                  naturales con inteligencia inmobiliaria especializada.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  Visualización de voz en tiempo real. VU meter premium con
                  colores adaptativos y análisis de frecuencia.
                </p>
              </motion.div>
            </div>
            ...
            >
              ...
              <div className="text-xs text-white/40 max-w-2xl mx-auto">
                <strong>Tecnologías implementadas:</strong> Canvas 2D •
                SpeechSynthesis API • SpeechRecognition API • WebAudio API •
                MediaDevices API • RequestAnimationFrame
              </div>
            </motion.div>
          </motion.div>
        </section>
        ...
        <section className="relative py-20">
          ...
          >
            <h2 className="text-5xl font-bold text-center text-white mb-16">
              Experiencias{" "}
              <span className="text-cyan-400">Revolucionarias</span>
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                  icon: "🌌",
                  title: "Portal Holográfico",
                  desc: "Entrada dimensional al metaverso inmobiliario",
                },
                {
                  icon: "🤖",
                  title: "IA Concierge",
                  desc: "Asistente premium con voz natural TTS/STT",
                },
                {
                  icon: "🗺️",
                  title: "España 3D Vivo",
                  desc: "Mapa interactivo con animaciones en tiempo real",
                },
                {
                  icon: "🏰",
                  title: "Galería Flotante",
                  desc: "Propiedades como obras de arte suspendidas",
                },
                {
                  icon: "🎙️",
                  title: "Voice Analytics",
                  desc: "Visualizador de voz en tiempo real con WebAudio",
                },
                {
                  icon: "🚀",
                  title: "VR Lounges",
                  desc: "Networking premium en espacios virtuales exclusivos",
                },
              ].map((feature, index) => (
                <motion.div
                  key={index}
