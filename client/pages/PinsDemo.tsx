        ...
        <div className="grid gap-8 lg:gap-12">
          ...
          <section>
            ...
            <p className="text-white/60 text-sm mt-4">
              Click on any pin to see detailed information. Premium pins have
          ...
          {/* Features */}
          <section>
            <h2 className="text-2xl font-bold mb-6 text-white">Pin Features</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="glass-card p-6">
                <h3 className="text-neon-teal font-semibold mb-3">
                  Heartbeat Animation
                </h3>
                <p className="text-white/70 text-sm">
                  Premium pins pulse with a realistic heartbeat pattern to draw
                  attention
                </p>
              </div>

              <div className="glass-card p-6">
                <h3 className="text-neon-emerald font-semibold mb-3">
                  Glow Effects
                </h3>
                <p className="text-white/70 text-sm">
                  Dynamic glow shadows that match the pin color and animate with
                  the pulse
                </p>
              </div>
              ...
              <div className="glass-card p-6">
                ...
                <p className="text-white/70 text-sm">
                  Teal, emerald, blue, and premium gradient variants for
              ...
              <div className="glass-card p-6">
                ...
                <p className="text-white/70 text-sm">
                  Glass-morphism labels that adapt to content and display price
                  information
                </p>
              </div>
              ...
              <div className="glass-card p-6">
                ...
                <p className="text-white/70 text-sm">
                  Active state management with detailed property information on
                  click
                </p>
              </div>
