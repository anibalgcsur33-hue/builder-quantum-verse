  ...
  const properties = [
    {
      ...
      featured: true,
      description:
        "Espectacular villa de lujo con vistas panorámicas al océano Atlántico.",
    ...
    },
    {
      ...
      featured: false,
      description:
        "Apartamento reformado en el corazón histórico de Las Palmas.",
    ...
    },
    {
      ...
      featured: true,
      description:
        "Auténtica casa canaria con viñedo propio en paisaje volcánico único.",
        ...
        <div className="container mx-auto container-padding">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Explora nuestra selección de propiedades reales en Canarias y
              España. Cada inmueble incluye tours VR y verificación registral.
            </p>
          </div>
          ...
          {filteredProperties.length >= 9 && (
            <div className="text-center mb-16">
              <button className="btn-secondary">Cargar más propiedades</button>
            </div>
          )}
          ...
          <div className="glass-card p-12 rounded-2xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="btn-primary">Hablar con Agente IA</button>
