  ...
  const legalCompliance = [
    {
      ...
      description:
        "Código auditado por empresas de seguridad blockchain reconocidas",
      icon: FileText,
      ...
      <div className="container mx-auto container-padding">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/70 max-w-4xl mx-auto leading-relaxed">
            Revolucionamos el sector inmobiliario con pagos en criptomonedas y
            nuestro token nativo BlueEye. Transacciones más rápidas, seguras y
            con ventajas exclusivas para holders.
          </p>
        </div>
                  ...
                  <div className="text-center">
                    <div
                      className={`w-16 h-16 rounded-full bg-white/10 flex items-center justify-center mx-auto mb-4 ${
                        crypto.id === "blueeye"
                          ? "bg-gradient-to-r from-neon-teal to-neon-emerald"
                          : ""
                      }`}
                    >
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Nuestro token nativo ofrece ventajas exclusivas y valor creciente
              para los holders
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {blueEyeTokenBenefits.map((benefit, index) => {
              ...
              return (
                <div
                  key={index}
                  className="glass-card p-6 rounded-xl hover-glow-teal"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <div className="text-white/60 text-sm mt-1">
                  Fijo, no inflacionario
                </div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-neon-emerald mb-2">
                  2%
                </div>
              ...
              <div className="text-3xl font-bold text-neon-teal mb-2 text-center">
                12%
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-white/70">
                      Cantidad en{" "}
                      {
                        supportedCryptos.find((c) => c.id === selectedCrypto)
                          ?.symbol
                      }
                      :
                    </span>
              ...
              {selectedCrypto === "blueeye" && (
                <div className="bg-neon-teal/10 border border-neon-teal/30 p-4 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <h5 className="font-bold text-neon-teal mb-1">
                        Ventajas adicionales
                      </h5>
                      <ul className="text-white/80 text-sm space-y-1">
                        <li>• Sin comisiones de transacción</li>
                        <li>
                          • {calculateTokenDiscount(purchaseAmount)}% descuento
                          en el precio
                        </li>
        ...
        <div className="text-center">
          <div className="glass-card p-12 rounded-2xl">
            ...
            <p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto">
              Únete al futuro de las transacciones inmobiliarias con pagos
              cripto y nuestro token BlueEye con beneficios exclusivos.
            </p>
